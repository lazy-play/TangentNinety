...
//    private int grarity;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (TextUtils.isEmpty(textCollapse)) {
            textCollapse = getResources().getString(R.string.collapse);
        }
        if (TextUtils.isEmpty(textExpand)) {
            textExpand = getResources().getString(R.string.expand);
        }
        contentTextColor = typedArray.getColor(R.styleable.ExpandTextView_contentTextColor, ContextCompat.getColor(getContext(),R.color.centerGrayColor));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandTextView_contentTextSize, UIUtil.sp2px(getContext(),14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(),R.color.centerGrayColor));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandTextView_collapseExpandTextSize, UIUtil.sp2px(getContext(),14));
