...
// BusUtil.getBus().post(new GlideCacheClearSuccessEvent());
    ...
    public String getCacheSize(Context context) {
        try {
            long glideCache=getFolderSize(new File(Constants.PATH_GLIDE_CACHE));
            long httpCache=getFolderSize(new File(Constants.PATH_NET_CACHE));

            return getFormatSize(glideCache+httpCache);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
